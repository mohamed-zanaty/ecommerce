...
<div id="related_product" class="tab-pane fade">
	...
	<div class="">
		...
		<form class="form-inline">
			...
			<i class="fa fa-spin fa-spinner fa-1x loading_data d-none" aria-hidden="true"></i>
			<i class="fa fa-search fa-2x do_search" aria-hidden="true"></i>
			<input class="form-control form-control-sm search col-md-4 d-inline-block" type="text" placeholder="Search"
			aria-label="Search">
		</form>
