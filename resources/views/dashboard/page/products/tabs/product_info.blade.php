<div id="product_info" class="tab-pane fade show active"  role="tabpanel">
	<h3>{{ trans('admin.product_info') }}</h3>
	<div class="form-group">
		{!! Form::label('title',trans('admin.product_title')) !!}
		{!! Form::text('title',$product->title,['class'=>'form-control','autocomplete'=>'off','placeholder'=>trans('admin.product_title')]) !!}
	</div>
	<div class="form-group">
