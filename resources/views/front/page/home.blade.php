...
@section('content')
    ...
    <main id="content" role="main">
        <!-- Slider Section -->
        <div class="mb-4">
            <div class="bg-img-hero" style="background-image: url({{asset('design/front/')}}/assets/img/1920X422/img2.jpg);">
                            ...
                            <div class="row pt-7 py-md-0">
                                ...
                                <div class="col-xl-7 col-6 d-flex align-items-end ml-auto ml-md-0"
                                    ...
                                    <img class="img-fluid ml-auto mr-10 mr-wd-auto"
                                         src="{{asset('design/front/')}}/assets/img/468X417/img1.png" alt="Image Description">
                                </div>
                            </div>
                        </div>
                        <div class="js-slide">
                            <div class="row pt-7 py-md-0">
                                ...
                                <div class="col-xl-7 col-6 flex-horizontal-center ml-auto ml-md-0"
                                     data-scs-animation-in="fadeInRight"
                                     data-scs-animation-delay="500">
                                    <img class="img-fluid ml-auto mr-10 mr-wd-auto h-100"
                                         src="{{asset('design/front/')}}/assets/img/416X420/img1.png" alt="Image Description">
                                </div>
                            </div>
                        </div>
                        <div class="js-slide">
                            <div class="row pt-7 py-md-0">
                                ...
                                <div class="col-xl-7 col-6 flex-horizontal-center ml-auto ml-md-0"
                                     ...
                                     data-scs-animation-delay="500">
                                    <img class="img-fluid ml-auto mr-10 mr-wd-auto h-100"
                                         src="{{asset('design/front/')}}/assets/img/416X420/img3.png" alt="Image Description">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mb-6 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                    ...
                    <a href="../shop/shop.html"
                       class="min-height-146 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                        <div class="col-6 col-xl-7 col-wd-6 pr-0">
                            <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/246X176/img1.jpg" alt="Image Description">
                        </div>
                ...
                <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
                    <a href="../shop/shop.html"
                       class="min-height-146 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                        <div class="col-6 col-xl-7 col-wd-6 pr-0">
                            <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/246X176/img2.jpg" alt="Image Description">
                        </div>
                        <div class="col-6 col-xl-5 col-wd-6 pr-xl-4 pr-wd-3">
                            <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                ...
                <div class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1">
                    <a href="../shop/shop.html"
                       class="min-height-146 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                        <div class="col-6 col-xl-7 col-wd-6 pr-0">
                            <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/246X176/img3.jpg" alt="Image Description">
                        </div>
                        <div class="col-6 col-xl-5 col-wd-6 pr-xl-4 pr-wd-3">
                            <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
                ...
                <div
                    class="col-md-6 mb-4 mb-xl-0 col-xl-4 col-wd-3 flex-shrink-0 flex-xl-shrink-1 d-xl-none d-wd-block">
                    <a href="../shop/shop.html"
                       class="min-height-146 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                        <div class="col-6 col-xl-5 col-wd-6 pr-0">
                            <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/190X150/img4.png" alt="Image Description">
                        </div>
                                            ...
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html"
                                                   class="d-block text-center"><img class="img-fluid"
                                                                                    src="{{asset('design/front/')}}/assets/img/212X200/img1.jpg"
                                    ...
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html"
                                                   class="d-block text-center"><img class="img-fluid"
                                                                                    src="{{asset('design/front/')}}/assets/img/212X200/img2.jpg"
                                                                                    alt="Image Description"></a>
                                            </div>
                                            <div class="flex-center-between mb-1">
                                    ...
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html"
                                                   class="d-block text-center"><img class="img-fluid"
                                                                                    src="{{asset('design/front/')}}/assets/img/212X200/img3.jpg"
                                                                                    alt="Image Description"></a>
                                            </div>
                                            <div class="flex-center-between mb-1">
                                                <div class="prodcut-price">
                                    ...
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html"
                                                   class="d-block text-center"><img class="img-fluid"
                                                                                    src="{{asset('design/front/')}}/assets/img/212X200/img4.jpg"
                                                                                    alt="Image Description"></a>
                                            </div>
                                            <div class="flex-center-between mb-1">
                                                <div class="prodcut-price">
                                    ...
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html"
                                                   class="d-block text-center"><img class="img-fluid"
                                                                                    src="{{asset('design/front/')}}/assets/img/212X200/img5.jpg"
                                                                                    alt="Image Description"></a>
                                            </div>
                                            <div class="flex-center-between mb-1">
                                                <div class="prodcut-price">
        ...
        <div class="mb-6" style="background-image: url({{asset('design/front/')}}/assets/img/1920X1080/img4.jpg);">
            <div class="container">
                <div class="row min-height-564 align-items-center">
                    <div class="col-12 col-lg-4 col-xl-5 col-wd-6 d-none d-md-block">
                        <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/665X616/img1.png" alt="Image Description">
                    </div>
                    <div class="col-12 col-lg-8 col-xl-7 col-wd-6 pt-6 pt-md-0">
                        <div class=" d-flex border-bottom border-color-1 mr-md-2">
                            <h3 class="section-title section-title__full mb-0 pb-2 font-size-22">Television
                                Entertainment</h3>
                        </div>
                        <div
                            class="js-slick-carousel position-static u-slick u-slick--gutters-2 u-slick overflow-hidden u-slick-overflow-visble py-5"
                            ...
                            <div class="js-slide">
                                <ul class="row list-unstyled products-group no-gutters mb-0 overflow-visible">
                                    <li class="col-md-6 product-item product-item__card mb-2 remove-divider pr-md-2 border-bottom-0">
                                        <div class="product-item__outer h-100 w-100">
                                            <div
                                                class="product-item__inner p-md-3 row no-gutters bg-white max-width-334">
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="../shop/single-product-fullwidth.html"
                                                       class="max-width-120 d-block"><img class="img-fluid"
                                                                                          src="{{asset('design/front/')}}/assets/img/150X140/img1.jpg"
                                                                                          alt="Image Description"></a>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <h5 class="product-item__title"><a
                                                                href="../shop/single-product-fullwidth.html"
                                                                class="text-blue font-weight-bold">Tablet Air 3 WiFi
                                                                64GB Gold</a></h5>
                                                    </div>
                                        ...
                                        <div class="product-item__outer h-100 w-100">
                                            <div
                                                ...
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="../shop/single-product-fullwidth.html"
                                                       class="max-width-120 d-block"><img class="img-fluid"
                                                                                          src="{{asset('design/front/')}}/assets/img/150X140/img2.jpg"
                                                                                          alt="Image Description"></a>
                                                </div>
                                                <div
                                                    class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1 pr-3 pr-md-0 pt-1 pt-md-0">
                                        ...
                                        <div class="product-item__outer h-100 w-100">
                                            <div
                                                ...
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="../shop/single-product-fullwidth.html"
                                                       class="max-width-120 d-block"><img class="img-fluid"
                                                                                          src="{{asset('design/front/')}}/assets/img/150X140/img3.jpg"
                                                                                          alt="Image Description"></a>
                                                </div>
                                                <div
                                                    class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1 pr-3 pr-md-0 pt-1 pt-md-0">
                                                    <div class="mb-2">
                                                        ...
                                                        <h5 class="product-item__title"><a
                                                                href="../shop/single-product-fullwidth.html"
                                                                class="text-blue font-weight-bold">Pendrive USB 3.0
                                                                Flash 64 GB</a></h5>
                                                    </div>
                                                    <div class="flex-center-between mb-2">
                                                        <div class="prodcut-price">
                                        ...
                                        <div class="product-item__outer h-100 w-100">
                                            <div
                                                ...
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="../shop/single-product-fullwidth.html"
                                                       class="max-width-120 d-block"><img class="img-fluid"
                                                                                          src="{{asset('design/front/')}}/assets/img/150X140/img7.jpg"
                                                                                          alt="Image Description"></a>
                                                </div>
                                                <div
                                                    class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1 pr-3 pr-md-0 pt-1 pt-md-0">
        ...
        <div class="container">
            ...
            <div class="mb-6 position-relative">
                ...
                <div
                    class="js-slick-carousel position-static u-slick u-slick--gutters-1 overflow-hidden u-slick-overflow-visble pt-3 pb-3"
                            ...
                            <li class="col-md-4 product-item product-item__card pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner p-md-3 row no-gutters">
                                        <div class="col col-lg-auto product-media-left">
                                            <a href="../shop/single-product-fullwidth.html"
                                               class="max-width-150 d-block" tabindex="0"><img class="img-fluid"
                                                                                               src="{{asset('design/front/')}}/assets/img/150X140/img4.jpg"
                                                                                               alt="Image Description"></a>
                                        </div>
                                        <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                            <div class="mb-4 mb-xl-2 mb-wd-6">
                                                <div class="mb-2"><a
                                                        href="../shop/product-categories-7-column-full-width.html"
                                                        class="font-size-12 text-gray-5" tabindex="0">Smartwatches</a>
                                                </div>
                                                <h5 class="product-item__title"><a
                                                        href="../shop/single-product-fullwidth.html"
                                                        class="text-blue font-weight-bold" tabindex="0">Smartwatch 2.0
                                                        LTE Wifi</a></h5>
                                            </div>
                                            <div class="flex-center-between mb-3">
                                                <div class="prodcut-price">
                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner p-md-3 row no-gutters">
                                        <div class="col col-lg-auto product-media-left">
                                            <a href="../shop/single-product-fullwidth.html"
                                               class="max-width-150 d-block" tabindex="0"><img class="img-fluid"
                                                                                               src="{{asset('design/front/')}}/assets/img/150X140/img5.jpg"
                                                                                               alt="Image Description"></a>
                                        </div>
                                        <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                            <div class="mb-4 mb-xl-2 mb-wd-6">
                                                ...
                                                <h5 class="product-item__title"><a
                                                        href="../shop/single-product-fullwidth.html"
                                                        class="text-blue font-weight-bold" tabindex="0">Gear Virtual
                                                        Reality</a></h5>
                                            </div>
                                            <div class="flex-center-between mb-3">
                                                <div class="prodcut-price">
                                    ...
                                    <div class="product-item__inner p-md-3 row no-gutters">
                                        ...
                                        <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                            <div class="mb-4 mb-xl-2 mb-wd-6">
                                                <div class="mb-2"><a
                                                        href="../shop/product-categories-7-column-full-width.html"
                                                        class="font-size-12 text-gray-5" tabindex="0">Headphones</a>
                                                </div>
                                                <h5 class="product-item__title"><a
                                                        href="../shop/single-product-fullwidth.html"
                                            ...
                                            <div class="product-item__inner bg-white p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    ...
                                                    <div class="mb-2">
                                                        <a href="../shop/single-product-fullwidth.html"
                                                           class="d-block text-center"><img class="img-fluid"
                                                                                            src="{{asset('design/front/')}}/assets/img/212X200/img7.jpg"
                                                                                            alt="Image Description"></a>
                                                    </div>
                                                    <div class="flex-center-between mb-1">
                                                        <div class="prodcut-price">
                                                    ...
                                                    <div class="mb-1 min-height-8-1">
                                                        <a href="#"
                                                           class="d-block text-center my-4 mt-lg-6 mb-xl-5 mb-lg-0 mt-xl-0 mb-xl-0 mt-wd-6 mb-wd-5"><img
                                                                class="img-fluid"
                                                                src="{{asset('design/front/')}}/assets/img/564X520/img2.jpg"
                                                                alt="Image Description"></a>
                                                        <!-- Gallery -->
                                                        <div class="row mx-gutters-2 mb-3">
                                                            <div class="col-auto">
                                                                ...
                                                                <a class="js-fancybox max-width-60 u-media-viewer"
                                                                   href="javascript:;"
                                                                   data-src="{{asset('design/front/')}}/assets/img/1920X1080/img1.jpg"
                                                                   data-fancybox="fancyboxGallery6"
                                                                   data-caption="Electro in frames - image #01"
                                                                   data-speed="700"
                                                                   data-is-infinite="true">
                                                                    <img class="img-fluid border"
                                                                         src="{{asset('design/front/')}}/assets/img/100X100/img1.jpg"
                                                            ...
                                                            <div class="col-auto">
                                                                ...
                                                                <a class="js-fancybox max-width-60 u-media-viewer"
                                                                   href="javascript:;"
                                                                   data-src="{{asset('design/front/')}}/assets/img/1920X1080/img2.jpg"
                                                                   data-fancybox="fancyboxGallery6"
                                                                   data-caption="Electro in frames - image #02"
                                                                   data-speed="700"
                                                                   data-is-infinite="true">
                                                                    <img class="img-fluid border"
                                                                         src="{{asset('design/front/')}}/assets/img/100X100/img2.jpg"
                                                                         alt="Image Description">
                                                            ...
                                                            <div class="col-auto">
                                                                ...
                                                                <a class="js-fancybox max-width-60 u-media-viewer"
                                                                   href="javascript:;"
                                                                   data-src="{{asset('design/front/')}}/assets/img/1920X1080/img3.jpg"
                                                                   data-fancybox="fancyboxGallery6"
                                                                   data-caption="Electro in frames - image #03"
                                                                   data-speed="700"
                                                                   data-is-infinite="true">
                                                                    <img class="img-fluid border"
                                                                         src="{{asset('design/front/')}}/assets/img/100X100/img3.jpg"
                                                                         alt="Image Description">
                                        ...
                                        <div class="h-100 w-100 prodcut-box-shadow">
                                            <div class="bg-white p-3">
                                                <div class="pb-xl-2">
                                                    <div class="mb-2">
                                                        <div
                                                            class="bg-gray-1 bg-animation rounded height-10 w-60"></div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <div
                                                            class="bg-gray-1 bg-animation rounded height-12 mb-1"></div>
                                                        <div
                                                            class="bg-gray-1 bg-animation rounded height-12 w-80"></div>
                                                    </div>
                                                    <div class="mb-4">
                                                    ...
                                                    <div class="flex-center-between mb-1">
                                                        <div
                                                            class="bg-gray-1 bg-animation rounded height-20 w-60"></div>
                                            ...
                                            <div class="bg-white p-3">
                                                <div class="d-flex flex-column">
                                                    <div class="mb-1">
                                                        <div class="mb-2">
                                                            <div
                                                                class="bg-gray-1 bg-animation rounded height-10 w-40"></div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <div
                                                                class="bg-gray-1 bg-animation rounded height-12 mb-1 w-90"></div>
                                                            <div
                                                                class="bg-gray-1 bg-animation rounded height-12 w-80"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="flex-center-between">
                                                        <div
                                                            class="bg-gray-1 bg-animation rounded height-20 w-40"></div>
        ...
        <div class="container">
            ...
            <div class="mb-2">
                <div class="border-bottom border-color-1 mb-5">
                    <h3 class="section-title section-title__full d-inline-block mb-0 pb-2 font-size-22">Top Categories
                        this Month</h3>
                </div>
                <div class="row align-items-start">
                    <div class="col-4 col-wd-3 border-right border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <div class="bg-gray-1 min-height-132"></div>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                <div class="mb-4">
                                    <div class="bg-gray-1 bg-animation rounded height-14 w-65"></div>
                                </div>

                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    <li>
                                        <div class="bg-gray-1 bg-animation rounded height-10 mb-2 w-50"></div>
                                    </li>
                                    <li>
                                        <div class="bg-gray-1 bg-animation rounded height-10 mb-2 w-60"></div>
                                    </li>
                                    <li>
                                        <div class="bg-gray-1 bg-animation rounded height-10 mb-2 w-50"></div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="bg-gray-1 bg-animation rounded height-10 mb-2 w-40"></div>
                                    </li>
                                    <li>
                                        <div class="bg-gray-1 bg-animation rounded height-10 mb-2 w-50"></div>
                                    </li>
                                ...
                                <div class="mt-2">
                                    <div class="ml-auto bg-gray-1 bg-animation rounded height-12 w-25"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/300X300/img2.png"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                    ...
                    <div class="col-4 col-wd-3 border-right remove-bd-xl-only border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/300X300/img3.jpg"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                    ...
                    <div class="col-4 col-wd-3 border-right remove-bd-wd border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/300X300/img4.jpg"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                    ...
                    <div class="col-4 col-wd-3 border-right border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/300X300/img5.jpg"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                    ...
                    <div class="col-4 col-wd-3 border-right remove-bd-xl-only border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/300X300/img6.jpg"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                    ...
                    <div class="col-4 col-wd-3 border-right border-lg-down-0 mb-8 d-xl-none d-wd-block">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/300X300/img7.png"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                    ...
                    <div class="col-4 col-wd-3 border-lg-down-0 mb-8 d-xl-none d-wd-block">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/300X300/img8.jpg"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
            ...
            <div class="position-relative">
                <div class="border-bottom border-color-1 mb-2">
                    <h3 class="section-title section-title__full d-inline-block mb-0 pb-2 font-size-22">Recommendation
                        for you</h3>
                </div>
                <div
                                    ...
                                    <div class="product-item__body pb-xl-2">
                                        ...
                                        <div class="mb-2">
                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img
                                                    class="img-fluid" src="{{asset('design/front/')}}/assets/img/212X200/img1.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="flex-center-between mb-1">
                                            <div class="prodcut-price">
                            ...
                            <div class="product-item__outer h-100 w-100">
                                <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                    <div class="product-item__body pb-xl-2">
                                        ...
                                        <div class="mb-2">
                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img
                                                    class="img-fluid" src="{{asset('design/front/')}}/assets/img/212X200/img2.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="flex-center-between mb-1">
                                            <div class="prodcut-price">
                            ...
                            <div class="product-item__outer h-100 w-100">
                                <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                    <div class="product-item__body pb-xl-2">
                                        ...
                                        <div class="mb-2">
                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img
                                                    class="img-fluid" src="{{asset('design/front/')}}/assets/img/212X200/img3.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="flex-center-between mb-1">
                                            <div class="prodcut-price">
                            ...
                            <div class="product-item__outer h-100 w-100">
                                <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                    <div class="product-item__body pb-xl-2">
                                        ...
                                        <div class="mb-2">
                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img
                                                    class="img-fluid" src="{{asset('design/front/')}}/assets/img/212X200/img4.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="flex-center-between mb-1">
                                            <div class="prodcut-price">
                            ...
                            <div class="product-item__outer h-100 w-100">
                                <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                    <div class="product-item__body pb-xl-2">
                                        ...
                                        <div class="mb-2">
                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img
                                                    class="img-fluid" src="{{asset('design/front/')}}/assets/img/212X200/img5.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="flex-center-between mb-1">
                                            <div class="prodcut-price">
                            ...
                            <div class="product-item__outer h-100 w-100">
                                <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                    <div class="product-item__body pb-xl-2">
                                        ...
                                        <div class="mb-2">
                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img
                                                    class="img-fluid" src="{{asset('design/front/')}}/assets/img/212X200/img6.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="flex-center-between mb-1">
                                            <div class="prodcut-price">
                            ...
                            <div class="product-item__outer h-100 w-100">
                                <div class="product-item__inner px-wd-4 p-2 p-md-3">
                                    <div class="product-item__body pb-xl-2">
                                        ...
                                        <div class="mb-2">
                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img
                                                    class="img-fluid" src="{{asset('design/front/')}}/assets/img/212X200/img7.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="flex-center-between mb-1">
                                            <div class="prodcut-price">
            ...
            <div class="mb-8">
                <div class="row">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <a href="../shop/shop.html">
                            <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/690X150/img1.jpg" alt="Image Description">
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="../shop/shop.html">
                            <img class="img-fluid" src="{{asset('design/front/')}}/assets/img/690X150/img2.jpg" alt="Image Description">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="js-slick-carousel u-slick my-1"
                    ...
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50" src="{{asset('design/front/')}}/assets/img/200X60/img1.png"
                                 alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50" src="{{asset('design/front/')}}/assets/img/200X60/img2.png"
                                 alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50" src="{{asset('design/front/')}}/assets/img/200X60/img3.png"
                                 alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50" src="{{asset('design/front/')}}/assets/img/200X60/img4.png"
                                 alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50" src="{{asset('design/front/')}}/assets/img/200X60/img5.png"
                                 alt="Image Description">
                        </a>
                    </div>
                    <div class="js-slide">
                        <a href="#" class="link-hover__brand">
                            <img class="img-fluid m-auto max-height-50" src="{{asset('design/front/')}}/assets/img/200X60/img6.png"
                                 alt="Image Description">
                        </a>
                    </div>
                </div>
