...
class UserDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'dashboard.page.user.btn.checkbox')
            ->addColumn('edit', 'dashboard.page.user.btn.edit')
            ->addColumn('delete', 'dashboard.page.user.btn.delete')
            ->addColumn('level', 'dashboard.page.user.btn.level')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
