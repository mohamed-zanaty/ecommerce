...
class ManuFactskDatatable extends DataTable {
	...
	public function dataTable($query) {
		return datatables($query)
			->addColumn('checkbox', 'dashboard.page.manufacturers.btn.checkbox')
			->addColumn('edit', 'dashboard.page.manufacturers.btn.edit')
			->addColumn('delete', 'dashboard.page.manufacturers.btn.delete')
			->rawColumns([
				'edit',
				'delete',
				'checkbox',
