...
class ShippingDatatable extends DataTable {
    ...
    public function dataTable($query) {
        return datatables($query)
            ->addColumn('checkbox', 'dashboard.page.shipping.btn.checkbox')
            ->addColumn('edit', 'dashboard.page.shipping.btn.edit')
            ->addColumn('delete', 'dashboard.page.shipping.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
