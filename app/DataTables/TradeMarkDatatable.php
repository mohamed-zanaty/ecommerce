...
class TradeMarkDatatable extends DataTable {
	...
	public function dataTable($query) {
		return datatables($query)
            ->addColumn('checkbox', 'dashboard.page.trademarks.btn.checkbox')
            ->addColumn('edit', 'dashboard.page.trademarks.btn.edit')
            ->addColumn('delete', 'dashboard.page.trademarks.btn.delete')
			->rawColumns([
				'edit',
				'delete',
				'checkbox',
