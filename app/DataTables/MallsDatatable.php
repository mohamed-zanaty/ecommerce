...
class MallsDatatable extends DataTable {
    ...
    public function dataTable($query) {
        return datatables($query)
            ->addColumn('checkbox', 'dashboard.page.malls.btn.checkbox')
            ->addColumn('edit', 'dashboard.page.malls.btn.edit')
            ->addColumn('delete', 'dashboard.page.malls.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
    ...
    protected function getColumns() {
        return [
            [
                ...
                'name'  => 'country_id.country_name_' . app()->getLocale(),
                'data'  => 'country_id.country_name_' . app()->getLocale(),
