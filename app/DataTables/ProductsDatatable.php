...
class ProductsDatatable extends DataTable
{
   ...
   public function dataTable($query)
   {
      return datatables($query)
         ->addColumn('checkbox', 'dashboard.page.products.btn.checkbox')
         ->addColumn('edit', 'dashboard.page.products.btn.edit')
         ->addColumn('delete', 'dashboard.page.products.btn.delete')
         ->rawColumns([
            'edit',
            'delete',
            'color',
