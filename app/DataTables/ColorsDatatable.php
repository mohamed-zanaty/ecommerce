...
class ColorsDatatable extends DataTable
{
   ...
   public function dataTable($query)
   {
      return datatables($query)
         ->addColumn('checkbox', 'dashboard.page.colors.btn.checkbox')
         ->addColumn('edit', 'dashboard.page.colors.btn.edit')
         ->addColumn('color', 'dashboard.page.colors.btn.color')
         ->addColumn('delete', 'dashboard.page.colors.btn.delete')
         ->rawColumns([
            'edit',
            'delete',
            'color',
